...
<img src={exam} alt='exam' />> Các bạn hãy mở file `index.jsx` + file
`index.html` trong source vừa tạo và bạn sẽ thấy thẻ `<div id='root'></div>`, đó
chính là nơi sẽ render ra ứng dụng của bạn.
